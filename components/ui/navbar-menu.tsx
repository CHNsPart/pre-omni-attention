...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="relative rounded-full border border-black/20 dark:bg-black dark:border-white/[0.2] bg-white shadow-input flex justify-center items-center space-x-4 px-8 py-6 w-fit"
    >
      {children}
    </nav>
  );
    ...
    <Link href={href} className="flex justify-center items-start p-4 border rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white dark:bg-gray-800">
      <div className="flex flex-col justify-center items-start w-56 h-40">
        ...
        <div>
          ...
          <p className="text-neutral-700 text-sm max-w-[15rem] mt-2 dark:text-neutral-300">
            {description}
          </p>
        </div>
      </div>
