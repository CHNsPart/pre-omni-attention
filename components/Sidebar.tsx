...
export default function Sidebar() {
  ...
  return (
    <div className="bg-white w-64 h-screen border-r sticky overflow-y-auto flex flex-col"
         style={{
           backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%239C92AC' fill-opacity='0.05'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,
         }}
    >
      <div className="w-full h-fit pl-5 pr-8 pt-10 flex items-center justify-start">
                ...
                <Link href={item.href} passHref>
                  <Button
                    ...
                    className={cn(
                      ...
                      isActive && "bg-gradient-to-t from-blue-100 via-blue-50 to-blue-50 text-blue-700 border border-white hover:bg-blue-200 hover:text-blue-800"
                    )}
